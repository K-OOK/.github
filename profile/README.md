# 🧑‍🍳 KOOK 🔗
현지 식재료로 쉽게 만드는 K-Food 레시피 웹앱
> 2025 숙명여대 캠퍼스타운 AI 해커톤 참여 프로젝트<br/>
> : AWS와 함께 AWS 클라우드와 Gen AI를 활용하여 Web/App/Bot을 개발하는 해커톤

<br/>

## 💡 Introduce

KOOK은 계속해서 세계로 나아가는 K-FOOD를 내 집에 있는 재료로 즐기고 싶은 외국인들에게,<br>
원하는 재료로 만들 수 있는 한식 레시피를 제공하는 서비스입니다.

**🥦 재료 기반 한식 추천**: commerce data 기반 최다 판매 식재료 혹은 직접 입력한 식재료를 기반으로 조리가능한 한식을 레시피를 제공합니다.<br>
**🔥 트렌드 중인 한식 레시피 제공**: 해외 커뮤니티에서 트렌드 중인 한식 리스트를 제공하고, 해당 한식의 레시피를 제공합니다.<br>
<br/>

## 🗣️ Contributor

| Backend & Data/Model | Frontend & Design | Frontend & Design |
|:----------:|:----------:|:----------:|
| [<img src="https://avatars.githubusercontent.com/11yubin" alt="" style="width:200px;200px;">](https://github.com/11yubin)<br/><div align="center">송유빈</div> | [<img src="https://avatars.githubusercontent.com/Anjihee" alt="" style="width:200px;200px;">](https://github.com/Anjihee)<br/><div align="center">안지희</div> | [<img src="https://avatars.githubusercontent.com/leeeyez" alt="" style="width:200px;200px;">](https://github.com/leeeyez) <br/><div align="center">이예지</div> |
